...
class ExtractLasClassFrame(ttk.LabelFrame):
    ...
    def __create_widgets(self):
        ...
        self.dropdown.grid(column=0, row=0, sticky="E")
        ...
        self.input_btn.grid(column=1, row=1, sticky="W")
        self.input_btn.config(width=3)

        #output entry
        self.output_entry = ttk.Entry(self)
        self.output_entry.grid(column=0, row=2)
        ...
        self.output_btn.grid(column=1, row=2, sticky="W")
