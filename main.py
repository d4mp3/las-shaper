...
class Las2ShpApp:
    ...
    # setInpath, sethOutpath, membery prywatne

    def extract_las_class(self, inpath, outpath):
    ...
    def create_shp_from_xyz(self, xyz, outpath):
    ...
    def create_xyz_from_las(self, las, outpath):
    ...
    def dem_handler(self, inpath, outpath, poly):
        ...
        for counter, path in enumerate(pathlist):
            ...
            results = self.intersect_using_spatial_index(points, poly)
    ...
    def intersect_using_spatial_index(self, source_gdf, intersecting_gdf):
        """
